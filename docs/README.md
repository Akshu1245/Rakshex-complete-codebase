...
Use these documents as the current release authority:

1. `../release/README_START_HERE.md`
2. `operations/PRODUCTION_DEPLOYMENT_RUNBOOK.md`
3. `operations/LAUNCH_SIGNOFF_MATRIX.md`
4. `operations/LIVE_SITE_REPLACEMENT_NOTICE.md`
5. `legal/WORD_DRAFT_PLACEHOLDER_REGISTER.md`
6. `../release/QA_EVIDENCE.md`
