...
## Scene 4 — The Kill Switch (0:30-0:42)
...
## Scene 5 — Compliance Export (0:42-0:52)

**Visual:** Compliance report page
**Action:** Click "Export PCI DSS Report" → PDF download
**VO:** "Export compliance reports in one click. PCI DSS, SOC 2, OWASP — ready for your auditor."
**Text overlay:** "PCI DSS v4.0.1 | 47 controls mapped | PDF generated"
...
2. **Voiceover:**
   - Speak slowly (120 WPM)
   - Pause 1 second between scenes
   - Use a quiet room or noise-cancelling mic

3. **Editing:**
   - Add text overlays in post (Canva or Descript)
   - No music needed — voiceover only
   - Total length: 58-62 seconds

4. **Hosting:**
   - Upload to YouTube (unlisted) for investor sharing
   - Embed on landing page hero
   - Add to Product Hunt launch post
