...
Use these templates for LinkedIn DMs, cold emails, and warm intros. Personalize the bracketed fields before sending.

---

## Template 1: Security-Focused (CISO / Security Lead)

**Subject:** [Company] — prompt injection attempt blocked at your LLM gateway?
...
- Kill switch that hard-stops traffic when budget or risk thresholds are breached
- PCI DSS and OWASP compliance reporting out of the box
...
## Template 2: Cost-Focused (Engineering Manager / VP Eng)

**Subject:** $[Estimate] in LLM spend last quarter — any surprises?
...
## Template 3: Compliance-Focused (Legal / GRC / Enterprise)

**Subject:** SOC 2 readiness for [Company]'s AI features

Hi [First Name],

If [Company] is processing customer data through LLMs, your auditors will eventually ask:
...
## Template 4: Warm Intro (Mutual Connection)
...
## Template 6: Product Hunt / Launch Day

**Subject:** Just launched on Product Hunt — AI security for production agents
...
Also happy to show you a demo if you’re evaluating AI security tools right now.
...
- **Personalize the first line** based on their company news, role, or recent post
- **Keep under 120 words** — busy people skim
- **One ask only** — demo, reply, or click
- **Track opens** with a lightweight tool (not required, but helpful)
- **Follow up 3 times** with 4-day gaps before moving on
