...
const OWASP_API_TOP_10: FrameworkControlDef[] = [
  ...
  },
  {
    ...
    findingKeywords: ["rate limit", "rate-limiting", "pagination", "resource consumption", "token limit"],
  },
  {
    id: "API5",
  ...
  },
  {
    ...
    findingKeywords: ["exposed key", "debug endpoint", "misconfiguration", "credential", "secret", "api key"],
  },
  {
    id: "API9",
...
const OWASP_LLM_TOP_10: FrameworkControlDef[] = [
  {
    ...
    findingKeywords: ["prompt injection", "injection", "jailbreak", "ignore instructions", "override"],
  },
  {
    id: "LLM02",
  ...
  },
  {
    ...
    findingKeywords: ["pii", "leak", "exfiltration", "sensitive information", "email leak", "credential leak"],
  },
  {
    id: "LLM07",
...
export function generateReport(
  ...
  return frameworks.map((fw) => {
    ...
    const results = controls.map((control) => {
      ...
      const maxSeverity = matchingFindings.length > 0
        ? (["Low", "Medium", "High", "Critical"].filter((s) =>
            matchingFindings.some((f) => f.severity === s),
