...
export default function TelemetryDashboardPage() {
  ...
  const avgLatency =
    totalRequests > 0
      ? Math.round(summary.reduce((s, d) => s + d.avgLatencyP50 * d.requestCount, 0) / totalRequests)
      : 0;
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
              ...
              <div className="bg-gray-800 p-5 rounded-lg border border-gray-700">
                ...
                <p className={`text-3xl font-bold mt-1 ${errorRate > 5 ? "text-red-400" : "text-yellow-400"}`}>
                  {errorRate.toFixed(1)}%
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
              <TokenSpendChart data={summary.map((s) => ({ key: s.key, totalCost: s.totalCost, totalTokens: s.totalTokens }))} />
