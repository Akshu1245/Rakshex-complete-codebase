...
export const metadata = {
  ...
  description: "Learn practical engineering strategies to reduce LLM API spend by 60% using caching, thinking token attribution, routing, and cost tracking.",
  keywords: ["LLM API cost", "OpenAI cost reduction", "thinking token attribution", "prompt caching", "model routing"],
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="w-full mb-8 rounded-xl overflow-hidden border border-slate-800 bg-slate-900/60 p-1 flex items-center justify-center">
          <svg viewBox="0 0 800 400" className="w-full h-auto rounded-lg bg-slate-950">
            ...
            <rect x="250" y="150" width="300" height="100" rx="10" fill="none" stroke="#34d399" strokeWidth="2" opacity="0.3" />
            ...
            <text x="50%" y="42%" textAnchor="middle" fill="#ffffff" fontSize="28" fontWeight="bold" fontFamily="sans-serif">REDUCE LLM COSTS BY 60%</text>
            <text x="50%" y="54%" textAnchor="middle" fill="#a7f3d0" fontSize="16" fontFamily="sans-serif">Practical Token & Gateway Optimization</text>
        ...
        <div className="prose prose-invert max-w-none text-slate-300 leading-relaxed space-y-6">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li><strong>Redundant System Prompts:</strong> Sending the same 3,000-token system instruction with every user message in a chat history.</li>
            <li><strong>Uncontrolled Loops:</strong> Autonomous agents getting stuck in reasoning loops, calling search tools repeatedly and burning thousands of context tokens.</li>
            <li><strong>Over-broad Context RAG:</strong> Feeding entire database rows or 50-page PDFs into the prompt window when only three sentences were needed.</li>
          </ul>
          ...
          <p>
            Both Anthropic and OpenAI support <strong>prompt caching</strong>. If you send a request that contains a prefix identical to a recent request, you get a 50% to 90% discount on the cached tokens.
          </p>
          <p>
            To maximize cache hits:
          </p>
          <ul className="list-disc list-inside space-y-2">
            <li>Keep the system instructions, tools specifications, and static documents at the very beginning of the prompt string.</li>
            <li>Structure conversations so historical turns remain static.</li>
            <li>Use a centralized API gateway that detects matching inputs and structures payloads to trigger provider caches.</li>
          </ul>
          ...
          <p>
            By implementing a <strong>model router</strong> in your API gateway, you can parse the complexity of incoming requests and direct them dynamically:
          </p>
          <ul className="list-disc list-inside space-y-2">
            <li><strong>Tier 1 (Low Cost):</strong> Standard classifications, summaries, and structural JSON mappings go to mini/haiku models.</li>
            <li><strong>Tier 2 (High Reasoning):</strong> Code generation, math reasoning, or multi-step logic flows are routed to Sonnet or reasoning engines.</li>
          </ul>
