...
export const metadata = {
  title: "DevPulse vs Portkey — Honest Comparison",
  description:
    "Portkey is an excellent LLM gateway. DevPulse adds security scanning, compliance, and enterprise governance. Side-by-side comparison.",
};
...
const features = [
  {
    ...
    devpulse: "Basic routing + kill switch integration",
  },
  {
    name: "Prompt Management",
    portkey: "Versioned prompt playground",
    devpulse: "Policy-based prompt guards",
  },
  {
    name: "Prompt Injection Detection",
    portkey: "Not available",
    devpulse: "Built-in engine with 50+ payloads",
  },
  {
    name: "API Security Scanning",
    portkey: "Not available",
    devpulse: "Postman / OpenAPI scanner + credential leak detection",
  },
  {
    name: "Shadow API Detection",
    portkey: "Not available",
    devpulse: "Automatic discovery of undocumented endpoints",
  },
  {
    name: "Compliance Reporting",
    portkey: "Not available",
    devpulse: "PCI DSS, OWASP, SOC 2 mapped controls",
  },
  {
    name: "Kill Switch / Budget Enforcement",
    portkey: "Basic rate limits",
    devpulse: "Hard kill switch + budget cap + multi-channel alerts",
  },
  {
  ...
  },
  {
    ...
    portkey: "Not available",
    devpulse: "PR-level security gate + auto-fix suggestions",
  },
  {
    name: "On-premise / Self-hosted",
    portkey: "Enterprise plan only",
    devpulse: "Docker Compose (free tier)",
  },
];
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white p-8">
      <div className="max-w-5xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-2">DevPulse vs Portkey</h1>
        <p className="text-xl text-gray-400 mb-8">
          Portkey is the best LLM gateway and router on the market. If you need gateway features +
          security + compliance in one stack, DevPulse covers the gaps Portkey leaves open.
        </p>
