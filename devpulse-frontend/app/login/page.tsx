...
export default function LoginPage() {
            ...
            <div className="bg-white/[0.03] border border-white/10 rounded-xl p-8">
              <form onSubmit={handle2FASubmit} className="space-y-5">
                ...
                <button
                  ...
                  className="w-full py-3 bg-[#2dd4bf] hover:bg-[#14b8a6] disabled:opacity-40 text-black font-semibold rounded-lg transition-colors"
                >
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white flex">
        ...
        <div className="w-full max-w-[400px]">
          ...
          <div className="space-y-3 mb-6">
            ...
            <a
              ...
              className="w-full flex items-center justify-center gap-2.5 px-3 py-2 bg-white text-black text-sm rounded-md font-medium transition-colors duration-200 hover:opacity-80 cursor-pointer"
            >
          ...
          <div className="w-full flex items-center">
            ...
            <span className="px-6 text-neutral-500 font-semibold text-sm select-none">or</span>
            <div className="flex-grow border-t border-neutral-500" />
          </div>
          <form onSubmit={handleSubmit} className="space-y-4" data-testid="login-form">
            <div>
              <label htmlFor="email" className="block text-sm text-neutral-50 mb-1">
                Email
              </label>
              <input
                id="email"
                ...
                className="w-full flex rounded bg-white/[0.04] border border-white/10 p-1.5 text-sm leading-5 text-white placeholder:text-neutral-600 transition-colors focus:outline-none focus:shadow-[0_0_0_1px_rgba(255,255,255,0.5),0_0_0_2px_#14B8A6] focus:border-white hover:bg-white/[0.08]"
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label htmlFor="password" className="block text-sm text-neutral-50">
                  Password
                </label>
                <button
                  type="button"
            ...
            <button
              ...
              className="w-full py-3 bg-[#2dd4bf] hover:bg-[#14b8a6] disabled:opacity-40 text-black font-semibold rounded-lg transition-colors text-sm"
            >
      ...
      {/* Right Panel — Wave Dots + Headline */}
      <div className="hidden lg:flex lg:flex-1 items-center justify-center relative overflow-hidden login-wave-bg">
        <WaveDotsCanvas />
        <div className="relative z-10 text-center">
          <h2 className="text-[42px] font-semibold text-white leading-tight">
